...
/* -------------------------------------------Employee Table--------------------------------------------------*/
INSERT INTO `db_final`.`employee` (`employee_id`, `employee_username`, `employee_password`, `employee_name`, `employee_phone`, `salary`) 
VALUES ('295375e3-4923-42b0-b09d-b8d3aa146ff6', 'roman', AES_ENCRYPT('roman', UNHEX(SHA2('sweet',512))), 'Roman Kunz', '3542051168', '5000');

INSERT INTO `db_final`.`employee` (`employee_id`, `employee_username`, `employee_password`, `employee_name`, `employee_phone`, `salary`) 
VALUES ('76f6b20e-9c24-4468-9c92-32c49dd84373', 'nevan', AES_ENCRYPT('nevan', UNHEX(SHA2('sweet',512))), 'Nevan Ríos', '5174750581', '6000');

INSERT INTO `db_final`.`employee` (`employee_id`, `employee_username`, `employee_password`, `employee_name`, `employee_phone`, `salary`) 
VALUES ('23867168-4808-4a69-a944-a7024d671794', 'antonia', AES_ENCRYPT('antonia', UNHEX(SHA2('sweet',512))), 'Antonia Faure', '6783462957', '3000');

INSERT INTO `db_final`.`employee` (`employee_id`, `employee_username`, `employee_password`, `employee_name`, `employee_phone`, `salary`) 
VALUES ('f577eb4d-4dba-4d8a-acf1-502d8fc25e99', 'marijn', AES_ENCRYPT('marijn', UNHEX(SHA2('sweet',512))), 'Marijn Martel', '1286934728', '4000');
